 ...
 * Twitter: @anchalsonu
 * Website: http://www.enetspark.com
 *
 * Copyright (C) 2011 Anchal Sharma (Enetspark Infotech Pvt. Ltd.)
 *
    ...
    <body class="migrate">
        <div id="migrate">
            ...
            <form name="migrateform" id="migrateform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				...
				$naya_address=(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].$_SERVER["SCRIPT_NAME"] ;
				$naya_address=str_replace("/migrate.php","",$naya_address); // added this so new url comes automatically
				?>

                    <label>New URL<br />
                        <input type="text" name="new_uri" id="new_uri" class="input" value="<?php echo $naya_address; ?>" size="20" tabindex="20" /></label>
                </p>
                <p class="runmeonce">
